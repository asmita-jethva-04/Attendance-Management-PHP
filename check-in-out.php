                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                <div class="col-12 text-center time">
                                    <!-- <button class="btn btn-light px-5 ms-2">Check In</button>
                                    <button class="btn btn-light px-5 ms-2">Check Out</button> -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" id="form-id" action="check-in-out-store.php" enctype="multipart/form-data">
                                                ...
                                                <input type="time" class="form-control mt-2" placeholder="Enter Check-in time" name="check-in">
                                                <input type="time" class="form-control mt-2" placeholder="Enter Check-out time" name="check-out">
                                                    ...
                                                    if($result->num_rows > 0){
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <td class='lg'>
                                                                ...
                                                                <a href='check-in-out-edit.php?id=" . $row['id'] . "'>
                                                                    <button class='show btn btn-sm btn-warning' type='button'>Edit</button>
                                                                </a>
                                                                <a href='check-in-out-delete.php?id=" . $row['id'] . "' onclick='return confirmDelete()'>
